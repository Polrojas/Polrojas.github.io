    ...
    curso: {
      ...
      desarrollos: [
        ...
        },
        {
          titulo: "Módulo 3",
          subtitulo:
            "Estado del arte del uso de corticoides inhalados (CI) en EPOC",
          docente: "Prof. Dr. Gustavo E. Zabert",
          nacionalidad: "Argentina",
          contenidos: [
            "CI en EPOC: racionalidad y variable de resultados significativos relacionados con el uso de CI en EPOC.",
            "CI como monoterapia,  asociados a LABA o en triple terapia vs LAMA y LABA-LAMA :  ensayos clínicos pivotales, efectividad y perfil de seguridad.",
            "CI según GOLD 2020 y nuevas evidencias para el tratamiento farmacológico en la EPOC ALAT 2019."
          ],
          objetivos: [
            "Describir las evidencias, la racionalidad y el perfil de seguridad de los CI en los pacientes con EPOC.",
            "Describir las evidencias de los CI como monoterapia, asociado a LABA y a triple terapia.",
            "Describir las evidencias sobre broncodilatación dual (LABA-LAMA) vs CI-LABA.",
            "Reconocer los fenotipos y marcadores que se proponen para escalar y desescalar el uso de CI en EPOC."
          ]
        },
        {
          titulo: "Módulo 4",
      ...
      docentes: [
        {
          ...
          nacionalidad: "Argentina",
          imagen: "DRzabert.png",
          bio: "Presidente 2018-2020 Asociación Latinoamericana del Tórax. Profesor Asociado Regular, Facultad de Ciencias Médicas, Universidad Nacional del Comahue Argentina. Director de Docencia, Clínica Pasteur, Neuquén Argentina. Ex-Presidente 2007-2008, Asociacion Argentina de Medicina Respiratoria."
        },
        {
          nombre: "Prof. Dra. Maria Montes de Oca",
          nacionalidad: "Venezuela",
          imagen: "DRoca.png",
          bio: "Médico Cirujano. Doctor en Ciencias Médicas. Especialista en Neumonología. Ex-Presidenta Asociación Latino Americana del Tórax (ALAT), 2012-2014. Jefe de la Cátedra, Servicio de Neumonología y Cirugía. Hospital Universitario de Caracas, Facultad de Medicina, UCV, Caracas, D.F. de Tórax."
        },
        {
          nombre: "Dr. Alejandro Casas",
          nacionalidad: "Colombia",
          imagen: "DRcasas.png",
          bio: "Médico Especialista en Medicina Interna y Neumología. Doctor (Ph. D ), Bio-Patología en Medicina, Universidad de Barcelona con tesis doctoral laureada Summa Cum Laude por unanimidad. Profesor Titular de Medicina Respiratoria, Universidad del Rosario, Bogotá. Ex-Presidente de la Asociación Latino Americana de Tórax (ALAT). Director General Fundación Neumológica Colombiana, Bogotá, Colombia."
        },
        {
          nombre: "Dr. Ricardo del Olmo",
          nacionalidad: "Argentina",
          imagen: "DRolmo.png",
          bio: "Médico especialista en Medicina Interna y Neumonología, Universidad de Buenos Aires. Integrante del Laboratorio Pulmonar, Hospital María Ferrer de Buenos Aires. Becario del Instituto Clínico del Tórax del Hospital Clinic i Provincial, Barcelona, Catalunya. Integrante del Comité de Espirometrías del Grupo EPOC.AR. Co-Director de la Conferencia Internacional sobre EPOC, Buenos Aires. Honorarios de la industria farmacéutica como consultoría, asistencia a congresos o investigación en los últimos 5 años de: AstraZeneca, Boehringer-Ingelheim, Gador, GSK, MundiPharma, Novartis, Phoenix, Sanofi-Genzyme. No tengo relación con la industria tabacalera ni de E-Cig."
        },
        {
        ...
        },
        {
          ...
          bio: "Miembro titular de la Sociedad Peruana de Tisiología, Neumología y Enfermedades del Tórax. Miembro titular de la Sociedad Europea de Enfermedades Respiratorias. Miembro Titular de la Asociación Americana del Tórax. Docente de la Facultad de Medicina de la Universidad Nacional Mayor de San Marcos. Presidente del Comité de Cuidados Intensivos de la Sociedad Peruana de Neumología. Director de la Unidad de Investigación y Docencia Clinica Internacional. Director Médico Ambulatorio, Clínica Internacional."
        },
        {
